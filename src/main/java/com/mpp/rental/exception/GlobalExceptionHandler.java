...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Void>> handleDuplicateBusinessException(DuplicateBusinessException ex) {
    ...
    /**
     * Handle ApplicationException (quota, pending check violations)
     */
